...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    ''' 
    # Save run settings Changed by Ashy
    if not evolve:
    ...
    amp = check_amp(model)  # check AMP
      ...
      # Define the teacher model by Ashley ---------------------------------------------------------------------------------
    if opt.distill:
...
def parse_opt(known=False):
    ...
    #Distilled Training Parameters ---------------------------------------------------------------------------  
    parser.add_argument('--distill', type=bool, default=True , help='Whether to use knowledge distillation training')
    parser.add_argument('--t_weights', type=str, default='yolov5l.pt' , help='Teacher Weights File')
    ...
    parser.add_argument('--a', type=float, default=0.3, help='Distillation loss as a percentage of total loss')
    # --------------------------------------------------------------------------------------------------------
